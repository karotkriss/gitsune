...
It backs `lib/core/syntax/gs_syntax_webview.dart`, the WebView fallback used for oversized full-file views when `re_highlight`'s native per-line path would be too slow.
