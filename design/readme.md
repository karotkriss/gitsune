...
- **Radii**: 10 controls (buttons/inputs, `--gs-radius-control`) · 4 tokens/tags · 8 tiles/alerts/code · 12 cards · 24–28 sheets/modals · full capsules for glass chrome, badges, labels. Users are circles; projects/groups rounded squares.
